  ...
  return (
    <section className={styles.introduction}>
      <div className={`${styles.introductionContainer} container`}>
        <h2 className={`${styles.introductionTitle} def-title`}>
          Знакомство <br />
          <span>
            c Интер
            <span>билим</span>
        ...
        <div className={styles.archive}>
          ...
          <div className={styles.archiveContent}>
            ...
            <p className={`${styles.archiveText} ${styles.introductionText}`}>
              За 30 лет «МЦ Интербилим» сыграл значительную роль в становлении и
              укреплении третьего сектора, содействуя формированию активного и
              сознательного гражданского общества.
            </p>
          </div>
        </div>
        <p
        ...
        >
          С первых дней своей работы «МЦ Интербилим» активно развивал и
          поддерживал организации гражданского общества, укрепляя их потенциал
          через информационную, консультационную и юридическую, техническую
          помощь. С этого времени «МЦ Интербилим» поддерживал активистов и
          лидеров Инициативных групп, делился инновационными подходами к
          адвокации и привлекал к общественному участию. Проекты «МЦ Интербилим»
          стали наглядным примером для обучения и вдохновения новых участников
          гражданского сектора.
        </p>
        <p className={styles.introductionText}>
          «МЦ Интербилим» благодарен доверию партнеров из НКО и государственного
          ...
          благополучателей. Только благодаря сотрудничеству с партнерами из НКО
          сектора «МЦ Интербилим» внес вклад в развитие гражданского общества в
          Кыргызстане через усиление потенциала НКО и гражданских активистов,
          оказывая содействие улучшению государственного управления через
          мониторинг, выработку рекомендаций и социальное партнерство и др.
        </p>

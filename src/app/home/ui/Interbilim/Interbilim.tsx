...
import reviews from "@/public/interbilim/reviews1.png";
    ...
    <section className={styles.interbilim}>
      <div className={`${styles.interbilimContainer} container`}>
        <div className={styles.values}>
          <h2 className={`${styles.valuesTitle} def-title`}>
            Ценн
            <span>
              <span>ости</span>
            </span>
        ...
        <div className={styles.numbers}>
          ...
          <ul className={styles.numbersList}>
            ...
            <li className={styles.numbersItem}>
              ...
              <p className={styles.numbersText}>человек посетили треннинги</p>
            </li>
          </ul>
        </div>
              ...
              <div className={styles.reviewsCard}>
                ...
                <div className={styles.reviewsContent}>
                  <p className={styles.reviewsText}>
                    ...
                    школу. По окончании Школы я съездил в обучающий тур в
                    Польшу, что тоже было очень ценным опытом для меня. Вся
                    программа была очень грамотно и интересно построена, мы
                    действительно и обучались, и встречались с другими лидерами,
                    и реализовывали позже свои мини-проекты. Наш проект касался
                    квотирования рабочих мест для ЛОВЗ. Был разработан пакет
                    документов для лоббирования квотирования рабочих мест для
                    инвалидов. По проекту разработки системы квотирования,
                    безбарьерной жизни для инвалидов: пандусы, мы приобрели
                    мощный опыт в убеждении, отстаивании интересов. Пакет был
                    передан в правовой отдел Министерства Труда и Социальной
                    Защиты, Министерство Юстиции и в отдел Жогорку Кенеш по
                    социальной политике для поправок в законодательство. ”
                  </p>
                </div>
              </div>
            </SwiperSlide>
